...
from datasets.cityscapes_2class import Cityscapes
from datasets.UAS import UAS
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='./datasets/data/UAS/',
                        help="path to Dataset")
    parser.add_argument("--dataset", type=str, default='UAS',
                        choices=['voc', 'cityscapes','UAS'], help='Name of dataset')
    ...
    parser.add_argument("--ckpt",
                        default='./checkpoints/latest_deeplabv3plus_resnet50_cityscapes_os16.pth', type=str,
                        # default=None,
...
def get_dataset(opts):
    ...
    if opts.dataset == 'UAS':
        ...
        train_dst = UAS(root=opts.data_root,
                               split='train', transform=train_transform)
        val_dst = UAS(root=opts.data_root,
                             split='val', transform=val_transform)
